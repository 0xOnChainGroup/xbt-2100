          ...
          <thead>
            <tr>
              <td className="titlebg2" height="32" align="right">
                <span className="smalltext">October 15, 2024, 02:35:39 PM</span>
                <a
                  href="#"
            ...
            <tr>
              <td width="90%" className="titlebg2">
                <span className="smalltext">
                  ...
                  <a className="ul" href="https://bitcoincore.org/en/download/">
                    <b>28.0</b>
                  </a>{" "}
                  [
                  <a
      ...
      <div id="bodyarea" style={{ padding: "1ex 0px 2ex 0px" }}>
          ...
          <thead>
            <tr>
              <td valign="bottom">
                ...
                >
                  <b>
                    <a href="https://bitcointalk.org/index.php" className="nav">
                      XBT 2100
                    </a>
                  </b>
                </div>
        ...
        <div className="tborder" style={{ marginTop: 0 }}>
          ...
          >
            ...
            <thead>
              <tr>
                ...
                <td className="windowbg2">
                  ...
                  Bitcoin network in general. No third-party sites/clients, bug
                  reports that do not require much discussion (use github), or
                  support requests.
                  <div style={{ paddingTop: "1px" }} className="smalltext">
                    <i>
                      Moderators:{" "}
            ...
            <thead>
              <tr>
                <td className="windowbg" width="6%" align="center" valign="top">
            ...
            <thead>
              <tr>
                ...
                <td className="windowbg2">
                  ...
                  discussion of how these currencies *relate to* Bitcoin may fit
                  in other categories.
                  <div style={{ paddingTop: "1px" }} className="smalltext">
                    <i>
                      Moderator:{" "}
                          ...
                          <td className="middletext" valign="top">
                            <b>
                              <a href="https://bitcointalk.org/index.php?topic=5512777.msg64636544;topicseen#msg64636544">
                                Re: &#128373;&#127995;&#8205;&#9794;&#65039;
                                [BOUNTY DETECTIVE] &#128309; Neuton - 1500 USDT
                                REWARD POOL&#128309;
                              </a>
                            </b>{" "}
                            by{" "}
